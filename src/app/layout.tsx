      ...
      <body className="bg-offWhite dark:bg-darkBg dark:text-darkText">
        <DarkModeProvider>
          ...
          <main className="flex min-h-screen pt-[70px]">
            ...
            <section className="w-full md:w-[80%] xl:w-[60%] flex justify-center shadow-xl bg-[white] dark:bg-darkBox rounded-xl md:mx-5 xl:mx-2">
              {children}
            </section>
            <aside className="w-[20%] hidden xl:block p-5 text-[gray]">
              <SocialLink />
              <div id="Toc" className="sticky top-20"></div>
            </aside>
          </main>
          <Footer />
        </DarkModeProvider>
